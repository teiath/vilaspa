<?php
namespace Vispanlab\CommonBundle\Wantlet\ORM;
 ...
 *
 * Usage: POINT_STR(:param) where param should be mapped to $point where $point is \Vispanlab\CommonBundle\Wantlet\ORM\Point
