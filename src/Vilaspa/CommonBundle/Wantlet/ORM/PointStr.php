<?php
namespace Vilaspa\CommonBundle\Wantlet\ORM;
 ...
 *
 * Usage: POINT_STR(:param) where param should be mapped to $point where $point is \Vilaspa\CommonBundle\Wantlet\ORM\Point
